...
gdjs.evtsExt__Jump3D__SetBottomZ.userFunc0x196dd10 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length === 0) {
    return;
}
...
gdjs.evtsExt__Jump3D__SetBottomZ.userFunc0x196dd10(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
