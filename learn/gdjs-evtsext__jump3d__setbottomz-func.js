...
gdjs.evtsExt__Jump3D__SetBottomZ.userFunc0x1985ba0 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length === 0) {
    return;
}
...
gdjs.evtsExt__Jump3D__SetBottomZ.userFunc0x1985ba0(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
